...
function initQuiz() {
        ...
        const submitButtonEl = document.getElementById("submit-name");
        ...
        function startQuiz() {
            ...
            function saveHighScore() {
                let nameEl = document.getElementById("name-entry");
                let newHighScore = {
                    name: nameEl.value,
                    highScore: score
                };
        ...
        highscoreButtonEl.addEventListener("click",function() {
            ...
            for (i=0; i<highScores.length; i++) {
                ...
                parEl.innerHTML = "name: " + highScores[i].name + "   Score: " + highScores[i].highScore;
                colEl2.append(parEl);
            }
        });
